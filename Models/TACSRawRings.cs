namespace EIR_9209_2.Models
{
    public class RawRings
    {
        ...
        public string? SourceTranId {get; set;} = Guid.NewGuid().ToString();
    ...
    public class RingInfo
    {
        ...
        public string? RscSuffix
        {
            get; set;
        }
        public string? OperationId { get; set; } 
        public string? LocalUnitNo
        {
            get; set;
        }
        ...
        public string? ActivityDurationQty
        {
            get; set;
        }
        public bool? ScheduledInd { get; set; }
        public string? PositionLevelNo
        {
            get; set;
        }
